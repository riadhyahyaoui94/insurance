...
class AssuranceControllerTest {
    ...
    void testAddAssurance2() {

        AssuranceController assuranceController = new AssuranceController(null);
        LocalDateTime atStartOfDayResult = LocalDate.of(1970, 1, 1).atStartOfDay();
        assuranceController.addAssurance(
    ...
    void testEditAssurance2() {
        ...
        AssuranceController assuranceController = new AssuranceController(new AssuranceServiceImpl(assuranceRepository));
        LocalDateTime atStartOfDayResult = LocalDate.of(1970, 1, 1).atStartOfDay();
        assuranceController.editAssurance(
                new AssuranceRequestDto("Nom Patient", "Prenom Patient", 10.0d, "Code Facture", "Type Prestation", 10.0d,
                        Date.from(atStartOfDayResult.atZone(ZoneId.of("UTC")).toInstant()), "Num Affeliation"),
                123L);
    }
